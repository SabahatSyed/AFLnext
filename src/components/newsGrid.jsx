...
export function NewsGrid({ data }) {
  ...
  // Split the data array into two arrays
  const News1 = data.data.slice(0, midpoint);
  const News2 = data.data.slice(midpoint);
  return (
    <div>
      <div className="bg-bgNews dark:bg-bg-dark2 flex flex-col py-6 md:pl-10 pl-5">
        ...
        <div className="flex flex-col ml-8">
          <div className="py-5 flex gap-[29px] overflow-x-scroll md:mr-0 custom-scrollbar ">
            {News1.map((result, index) => (
              <div
                key={index}
                className=" bg-white min-h-[430px] min-w-[310px] md:min-w-[310px] dark:bg-bgdark  rounded-3xl shadow overflow-hidden">
                <div className="">
                  {/* <img
                  ...
                  <div className="px-5 py-8  flex flex-col gap-3">
                    ...
                    <p className="font-roboto font-light text-sm text-gray-500 line-clamp-3 overflow-hidden ">
                      ...
                      assumenda sunt architecto tenetur accusantium,
                      dignissimos, illum, perspiciatis et amet provident ipsa
                      accusamus.
                    </p>
                    <Link
                      href={"/"}
