  ...
  return (
    ...
    <div className="">
      ...
      <div className=" bg-bgblue px-14 py-10 flex flex-col gap-7">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-2 text-white lg:gap-0 text-xs lg:text-[13px]  mx-auto uppercase font-bold font-magistral text-center place-content-center justify-items-center place-items-center">
          <p>privacy policy</p>
          <p>terms of service</p>
          <p>subscription terms and conditions</p>
          <p>media</p>{" "}
          <p className=" lowercase flex-wrap font-normal">
            powered by <span className="uppercase font-semibold text-lg">HUMBL</span>
          </p>
        </div>
      </div>
    </div>
