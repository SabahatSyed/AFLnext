            ...
            <table className="min-w-full divide-y divide-gray-200 font-roboto">
              <thead className="">
                <tr className="border-b border-headingblue">
                  ...
                  <th className="border-l-4 border-headingblue border-t min-w-[4rem] md:min-w-[5rem] text-xs">
                    Att
                  </th>
                  <th className="border-t border-headingblue min-w-[4rem] md:min-w-[5rem] text-xs">
                    Cmp
                  </th>
                  <th className="border-t border-headingblue min-w-[4rem] md:min-w-[5rem] text-xs">
                    Cmp %
                  </th>
                  <th className="border-r border-headingblue border-t min-w-[4rem] md:min-w-[5rem] text-xs">
                    YdsAtt
                  </th>
                  <th className="border-t border-headingblue min-w-[4rem] md:min-w-[5rem] text-xs">
                    PassYds
                  ...
                  <th className="border-t border-r border-headingblue min-w-[4rem] md:min-w-[5rem] text-xs">
                    Sck
                  </th>
                  <th className="border-r-4 border-headingblue border-t min-w-[4rem] md:min-w-[5rem] text-xs">
                    SckY
                  </th>
                </tr>
              </thead>
              ...
              /> */}
                    <td
                      style={{
                        borderLeftColor: `${result.attributes.svgColor.replace(
                          /\s/g,
                          ""
                        )}`,
                        borderLeftWidth: 5,
                      ...
                      <img
                        src={`http://afl-cms.logixsy.com${result.attributes.icon.data.attributes.url}`}
                        alt="outLaws"
